...
namespace Navtech::Networking {
    ...
    //
    template <>
    class Datagram_client_traits<Protocol::cat240, Transport::udp, TLS::Type::none> {
    public:
        // Types
        //
    ...
    //
    template <>
    class Datagram_client_traits<Protocol::nmea, Transport::udp, TLS::Type::none> {
    public:
        // Types
        //
    ...
    //
    template <>
    class Datagram_client_traits<Protocol::colossus, Transport::udp, TLS::Type::none> {
    public:
        // Types
        //
