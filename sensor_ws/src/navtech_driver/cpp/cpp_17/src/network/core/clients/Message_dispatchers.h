...
namespace Navtech::Networking {
    ...
    //
    template <Protocol protocol, Transport transport, TLS::Type tls, typename Sender_Ty>
    ...
    template <Protocol protocol, Transport transport, TLS::Type tls, typename Sender_Ty>
    Message_dispatcher<protocol, transport, tls, Sender_Ty>::Message_dispatcher(
        Sender_Ty&                                                              msg_sender, 
        Message_dispatcher<protocol, transport, tls, Sender_Ty>::Dispatcher_Ty& event_dispatcher
    ) : 
    ...
    template <Protocol protocol, Transport transport, TLS::Type tls, typename Sender_Ty>
    void Message_dispatcher<protocol, transport, tls, Sender_Ty>::attach_impl(Type_Ty type, const Handler& handler)
    {
    ...
    template <Protocol protocol, Transport transport, TLS::Type tls, typename Sender_Ty>
    void Message_dispatcher<protocol, transport, tls, Sender_Ty>::detach_impl(Type_Ty type)
    {
    ...
    template <Protocol protocol, Transport transport, TLS::Type tls, typename Sender_Ty>
    void Message_dispatcher<protocol, transport, tls, Sender_Ty>::dispatch(Message_Ty& msg)
    {
    ...
    template <Protocol protocol, Transport transport, TLS::Type tls, typename Sender_Ty>
    void Message_dispatcher<protocol, transport, tls, Sender_Ty>::on_stop()
    {
    ...
    template <Protocol protocol, Transport transport, TLS::Type tls, typename Sender_Ty>
    Addressed_message_dispatcher<protocol, transport, tls, Sender_Ty>::Addressed_message_dispatcher(
        Addressed_message_dispatcher<protocol, transport, tls, Sender_Ty>::ID_Ty            listen_for, 
        Sender_Ty&                                                                          msg_sender,
        Addressed_message_dispatcher<protocol, transport, tls, Sender_Ty>::Dispatcher_Ty&   event_dispatcher
    ) : 
    ...
    template <Protocol protocol, Transport transport, TLS::Type tls, typename Sender_Ty>
    void Addressed_message_dispatcher<protocol, transport, tls, Sender_Ty>::attach_impl(Type_Ty type, const Handler& handler)
    {
        message_handlers.try_emplace(type, handler);
    }
    ...
    template <Protocol protocol, Transport transport, TLS::Type tls, typename Sender_Ty>
    void Addressed_message_dispatcher<protocol, transport, tls, Sender_Ty>::detach_impl(Type_Ty type)
    {
        message_handlers.erase(type);
    }
    ...
    template <Protocol protocol, Transport transport, TLS::Type tls, typename Sender_Ty>
    void Addressed_message_dispatcher<protocol, transport, tls, Sender_Ty>::dispatch(Message_Ty& msg)
    {
        if (message_handlers.count(Protocol_traits::type(msg)) == 1) {
            message_handlers[Protocol_traits::type(msg)](*sender, msg);
        }
    ...
    template <Protocol protocol, Transport transport, TLS::Type tls, typename Sender_Ty>
    void Addressed_message_dispatcher<protocol, transport, tls, Sender_Ty>::on_stop()
    {
        dispatcher->template detach_from<Event_traits::Received_message>(receive_handler);
    }
