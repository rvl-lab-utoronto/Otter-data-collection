...
namespace Navtech::Networking::TLS {
    ...
    void Configuration::store()
    {
        ...
        settings_protobuf.set_server_certificate(certificate_filename.string());
        settings_protobuf.set_server_key(key_filename.string());
