...
// ---------------------------------------------------------------------------------------------------------------------
#ifndef COLOSSUS_TCP_NETWORK_MESSAGE_H
#define COLOSSUS_TCP_NETWORK_MESSAGE_H

#include <cstdint>
#include <vector>
#include <cstring>

#include "Colossus_TCP_message_types.h"
...
namespace Navtech::Networking {
    ...
    namespace Colossus_protocol::TCP {
        ...
        public:
            ...
            Message(const Networking::IP_address& ip_addr, ID id, const Buffer& message);
            Message(const Networking::IP_address& ip_addr, ID id, Buffer&& message);
            Message(const Networking::IP_address& ip_addr, ID id, Const_iterator message_start, std::size_t message_sz);
            ...
            Message& append(Const_iterator buffer_begin, Const_iterator buffer_end);
...
#endif // COLOSSUS_TCP_NETWORK_MESSAGE_H