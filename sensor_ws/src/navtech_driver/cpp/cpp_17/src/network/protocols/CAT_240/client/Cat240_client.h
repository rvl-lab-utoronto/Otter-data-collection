...
namespace Navtech::Networking::Cat240_protocol {
    ...
    public:
        ...
        using Dispatcher    = Message_dispatcher<Protocol::cat240, Transport::udp, TLS::Type::none, Client>;
        using Dgram_client  = Datagram_client<Protocol::cat240, Transport::udp>;
