...
// ---------------------------------------------------------------------------------------------------------------------
#ifndef COLOSSUS_UDP_PROTOCOL_TRAITS_H
#define COLOSSUS_UDP_PROTOCOL_TRAITS_H
...
namespace Navtech::Networking {
	...
	template <>
	class Protocol_traits<Protocol::colossus, Transport::udp, TLS::Type::none> {
	public:
		using Message           = Navtech::Networking::Colossus_protocol::UDP::Message;
        using Pointer           = Navtech::Networking::Colossus_protocol::UDP::Pointer;
		using ID                = Message::ID;
		using Type              = Navtech::Networking::Colossus_protocol::UDP::Type;
		...
		static constexpr const char* name { "Colossus UDP" };
...
#endif // COLOSSUS_UDP_PROTOCOL_TRAITS_H