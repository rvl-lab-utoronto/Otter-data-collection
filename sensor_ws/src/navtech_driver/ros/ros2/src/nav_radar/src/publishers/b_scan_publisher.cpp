...
bool B_scan_colossus_publisher::rotated_once(Azimuth_num azimuth)
{
...
bool B_scan_colossus_publisher::completed_full_rotation(Azimuth_num azimuth)
{
...
void B_scan_colossus_publisher::fft_data_handler(Client& radar_client [[maybe_unused]], Message& msg)
{
    using namespace Navtech::Networking;
    using namespace Navtech::Time::Monotonic;
...
void B_scan_colossus_publisher::configuration_data_handler(Client& radar_client [[maybe_unused]], Message& msg) {
