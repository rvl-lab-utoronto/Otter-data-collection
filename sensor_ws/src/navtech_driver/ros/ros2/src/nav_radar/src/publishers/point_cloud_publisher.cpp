...
bool Point_cloud_publisher::rotated_once(Azimuth_num azimuth)
{
...
bool Point_cloud_publisher::completed_full_rotation(Azimuth_num azimuth)
{
...
void Point_cloud_publisher::publish_point_cloud()
{
...
void Point_cloud_publisher::fft_data_handler(Client& radar_client [[maybe_unused]], Message& msg)
{
    using namespace Navtech::Networking;
    using namespace Navtech::Time::Monotonic;
...
void Point_cloud_publisher::configuration_data_handler(Client& radar_client [[maybe_unused]], Message& msg)
{
...
std::vector<std::uint8_t> Point_cloud_publisher::to_ros_format(const Degrees& bearing, const Metre& range, const Navtech::Unit::dB& power)
{
    using namespace std;
