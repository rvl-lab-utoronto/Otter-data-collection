...
bool Laser_scan_publisher::rotated_once(Azimuth_num azimuth)
{
...
bool Laser_scan_publisher::completed_full_rotation(Azimuth_num azimuth)
{
...
void Laser_scan_publisher::publish_laser_scan(Message& msg)
{
    ...
    auto fft  = msg.view_as<Navtech::Networking::Colossus_protocol::TCP::FFT_data>();
...
void Laser_scan_publisher::fft_data_handler(Client& radar_client [[maybe_unused]], Message& msg)
{
    using namespace Navtech::Networking;
    using namespace Navtech::Time::Monotonic;
...
void Laser_scan_publisher::configuration_data_handler(Client& radar_client [[maybe_unused]], Message& msg)
{
    ...
    config_range_offset = config->range_offset();
