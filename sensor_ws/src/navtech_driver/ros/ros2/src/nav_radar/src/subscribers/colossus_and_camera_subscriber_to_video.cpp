...
Colossus_and_camera_subscriber_to_video::Colossus_and_camera_subscriber_to_video():Node{ "colossus_and_camera_subscriber_to_video" }
{
    ...
    Node::create_subscription<navtech_msgs::msg::CameraConfigurationMessage>(
...
void Colossus_and_camera_subscriber_to_video::configuration_data_callback(const navtech_msgs::msg::RadarConfigurationMsg::SharedPtr msg) const
{
...
void Colossus_and_camera_subscriber_to_video::fft_data_callback(const navtech_msgs::msg::RadarFftDataMsg::SharedPtr msg) const
{
    if (!node->config_data_received) {
...
void Colossus_and_camera_subscriber_to_video::camera_configuration_data_callback(const navtech_msgs::msg::CameraConfigurationMessage::SharedPtr data) const
{
