...
if __name__ == "__main__":
    ...
    formatted_timestamps = pd.to_datetime(radar_stamps)
    formatted_times = formatted_timestamps.strftime('%H:%M:%S.%f')[:-2]
